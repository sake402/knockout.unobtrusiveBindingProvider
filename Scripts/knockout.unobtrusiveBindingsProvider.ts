...
((instance) => {
    instance["getBindingsString"] = (node: HTMLElement, bindingContext: KnockoutBindingContext) => node.getBindingsString(bindingContext, ko.bindingProvider["bindings"]);
...
class Bindings {
                    ...
                    for (var name in obj) {
                        if (obj.hasOwnProperty(name)) {
                            ...
                            if (!(v === null || v === undefined)) {
                                ...
                                else if (typeof v === "object") { v = `{${Bindings.from(v) }}`; }
    ...
    static get(r: { name: string; value: any }, node: Node) {
...
Object.defineProperty(Node.prototype, "path", {
    get() {
        ...
        if (this.className) { value += `.${this.className.replace(/\s/g, ".") }`; }
