(function () {
    (function (p) {
        ...
        (function (p) { "function" === typeof define && define.amd ? define(["exports", "require"], p) : "function" === typeof require && "object" === typeof exports && "object" === typeof module ? p(module.exports || exports) : p(y.ko = {}); })(function (N, O) {
            ...
            function R(a, d) { var c; return function () { c || (c = setTimeout(function () { c = p; a(); }, d)); }; }
            function S(a, d) {
                var c;
                return function () {
                    clearTimeout(c);
            ...
            a.a = function () {
                ...
                function e(b, c, g, d) { var e = b[c].match(m) || []; a.a.o(g.match(m), function (b) { a.a.ga(e, b, d); }); b[c] = e.join(" "); }
                ...
                return { Bb: ["authenticity_token", /^__RequestVerificationToken(_.*)?$/], o: function (a, b) {
                        ...
                        for (var g = 0, d = a.length; g < d; g++)
                            if (b.call(c, a[g], g))
                                return a[g];
                        return null;
                    }, ya: function (b, c) { var g = a.a.m(b, c); 0 < g ? b.splice(g, 1) : 0 === g && b.shift(); }, wb: function (b) {
                        b = b || [];
                        ...
                        if (b instanceof Array)
                            ...
                            for (var c = 0, g = b.length; c < g; c++)
                                a.push(b[c]);
                        return a;
                    }, ga: function (b, c, g) { var d = a.a.m(a.a.cb(b), c); 0 > d ? g && b.push(c) : g || b.splice(d, 1); }, za: f, extend: d, Fa: c, Ga: f ? c : d, A: b, pa: function (a, b) {
                        if (!a)
                            return a;
                        var c = {}, g;
                        for (g in a)
                    ...
                    }, mc: function (a) { 9 <= g && (a = 1 == a.nodeType ? a : a.parentNode, a.style && (a.style.zoom = a.style.zoom)); }, kc: function (a) {
                        if (g) {
                            var b = a.style.width;
                            a.style.width = 0;
                            a.style.width = b;
                        ...
                        b(m, function (a, b) { var c = w.createElement("input"); c.type = "hidden"; c.name = a; c.value = b; s.appendChild(c); });
            ...
            a.a.f = new function () {
                ...
                return { get: function (c, d) { var e = a(c, !1); return e === p ? p : e[d]; }, set: function (c, d, e) {
                        if (e !== p || a(c, !1) !== p)
                            a(c, !0)[d] = e;
            ...
            a.a.C = new function () {
                function b(b, d) { var e = a.a.f.get(b, c); e === p && d && (e = [], a.a.f.set(b, c, e)); return e; }
                function d(c) {
                    var e = b(c, !1);
                    if (e)
                ...
                return { fa: function (a, c) {
                        ...
                        return b;
                    }, removeNode: function (b) { a.S(b); b.parentNode && b.parentNode.removeChild(b); }, cleanExternalData: function (a) { u && "function" == typeof u.cleanData && u.cleanData([a]); } };
            };
            a.S = a.a.C.S;
            ...
            a.Sa = { throttle: function (b, d) { b.throttleEvaluation = d; var c = null; return a.j({ read: b, write: function (a) { clearTimeout(c); c = setTimeout(function () { b(a); }, d); } }); }, rateLimit: function (a, d) { var c, e, f; "number" == typeof d ? c = d : (c = d.timeout, e = d.method); f = "notifyWhenChangesStop" == e ? S : R; a.Za(function (a) { return f(a, c); }); }, notify: function (a, d) {
                    a.equalityComparer =
                        "always" == d ? null : J;
                } };
            var Q = { undefined: 1, "boolean": 1, number: 1, string: 1 };
            a.b("extenders", a.Sa);
            a.Ub = function (b, d, c) { this.da = b; this.La = d; this.hc = c; this.Gb = !1; a.D(this, "dispose", this.p); };
            a.Ub.prototype.p = function () { this.Gb = !0; this.hc(); };
            a.Q = function () { a.a.Ga(this, a.Q.fn); this.G = {}; this.rb = 1; };
            var z = { U: function (b, d, c) { var e = this; c = c || "change"; var f = new a.Ub(e, d ? b.bind(d) : b, function () { a.a.ya(e.G[c], f); e.ua && e.ua(c); }); e.ja && e.ja(c); e.G[c] || (e.G[c] = []); e.G[c].push(f); return f; }, notifySubscribers: function (b, d) {
                    d = d || "change";
                    "change" === d && this.Yb();
                    if (this.Ba(d))
                        try {
                ...
                }, Aa: function () { return this.rb; }, pc: function (a) { return this.Aa() !== a; }, Yb: function () { ++this.rb; }, Za: function (b) {
                    ...
                    var h = b(function () { c && k === d && (k = d()); e = !1; d.Wa(f, k) && d.ta(f = k); });
                    d.qb = function (a) {
                        e = !0;
                        k = a;
                        h();
                ...
                }, Ba: function (a) { return this.G[a] && this.G[a].length; }, nc: function (b) {
                    if (b)
                        return this.G[b] && this.G[b].length || 0;
                    var d = 0;
                    a.a.A(this.G, function (a, b) { d += b.length; });
                    return d;
                }, Wa: function (a, d) { return !this.equalityComparer || !this.equalityComparer(a, d); }, extend: function (b) { var d = this; b && a.a.A(b, function (b, e) { var f = a.Sa[b]; "function" == typeof f && (d = f(d, e) || d); }); return d; } };
            a.D(z, "subscribe", z.U);
            ...
            a.ba.fn = { remove: function (b) {
                ...
                removeAll: function (b) {
                    ...
                    this.W();
                }, destroyAll: function (b) { return b === p ? this.destroy(function () { return !0; }) : b ? this.destroy(function (d) { return 0 <= a.a.m(b, d); }) : []; }, indexOf: function (b) {
                    var d = this();
                    return a.a.m(d, b);
                }, replace: function (a, d) { var c = this.indexOf(a); 0 <= c && (this.X(), this.B()[c] = d, this.W()); } };
            a.a.o("pop push reverse shift sort splice unshift".split(" "), function (b) { a.ba.fn[b] = function () { var a = this.B(); this.X(); this.yb(a, b, arguments); a = a[b].apply(a, arguments); this.W(); return a; }; });
            a.a.o(["slice"], function (b) { a.ba.fn[b] = function () { var a = this(); return a[b].apply(a, arguments); }; });
            ...
            a.Sa.trackArrayChanges = function (b) {
                function d() {
                    if (!c) {
                        ...
                        b.notifySubscribers = function (a, b) { b && "change" !== b || ++k; return g.apply(this, arguments); };
                        var d = [].concat(b.B() || []);
                        e = null;
                        f = b.U(function (c) {
                            c = [].concat(c || []);
                ...
                if (!b.yb) {
                    ...
                    b.ja = function (a) { h && h.call(b, a); "arrayChange" === a && d(); };
                    b.ua = function (a) { l && l.call(b, a); "arrayChange" !== a || b.Ba("arrayChange") || (f.p(), c = !1); };
                    b.yb = function (b, d, f) {
            ...
            a.w = a.j = function (b, d, c) {
                ...
                function k() { !s && B && a.a.A(B, function (a, b) { b.p && b.p(); }); B = null; F = 0; G = !0; s = r = !1; }
                function h() { var a = g.throttleEvaluation; a && 0 <= a ? (clearTimeout(z), z = setTimeout(function () { l(!0); }, a)) : g.nb ? g.nb() : l(!0); }
                function l(b) {
                    if (!v && !G) {
                        if (y && y()) {
                            if (!t) {
                ...
                g.$ = x;
                var T = g.Za;
                g.Za = function (a) { T.call(g, a); g.nb = function () { g.pb(n); r = !0; g.qb(g); }; };
                c.pure ? (s = I = !0, g.ja = function (b) {
                    if (!G && s && "change" == b) {
                        ...
                        if (r || f())
                            ...
                            a.a.o(c, function (a, b) { var c = B[a], g = c.da.U(h); g.sa = b; g.ea = c.ea; B[a] = g; });
                        }
                        G || q(n, "awake");
                    }
                }, g.ua = function (b) {
                    G || "change" != b || g.Ba("change") || (a.a.A(B, function (a, b) { b.p && (B[a] = { da: b.da, sa: b.sa, ea: b.ea }, b.p()); }),
                        s = !0, q(p, "asleep"));
                }, g.bc = g.Aa, g.Aa = function () { s && (r || f()) && l(); return g.bc(); }) : c.deferEvaluation && (g.ja = function (a) { "change" != a && "beforeChange" != a || m(); });
                a.D(g, "peek", g.B);
                a.D(g, "dispose", g.p);
                a.D(g, "isActive", g.$);
                ...
                D && x() && D.nodeType && (w = function () { a.a.C.Pb(D, w); k(); }, a.a.C.fa(D, w));
                return g;
            };
            ...
            (function () {
                ...
                a.toJSON = function (b, c, d) { b = a.Vb(b); return a.a.jb(b, c, d); };
                c.prototype = { save: function (b, c) { var d = a.a.m(this.keys, b); 0 <= d ? this.mb[d] = c : (this.keys.push(b), this.mb.push(c)); }, get: function (b) { b = a.a.m(this.keys, b); return 0 <= b ? this.mb[b] : p; } };
            })();
            a.b("toJS", a.Vb);
            a.b("toJSON", a.toJSON);
            (function () {
            ...
            (function () {
                ...
                a.e = { R: {}, childNodes: function (a) { return b(a) ? c(a) : a.childNodes; }, ma: function (c) {
                        if (b(c)) {
                            c = a.e.childNodes(c);
                    ...
                    }, oc: b, Fc: function (a) { return (a = (f ? a.text : a.nodeValue).match(k)) ? a[1] : null; }, Kb: function (c) {
                        if (l[a.a.v(c)]) {
                            var m = c.firstChild;
                            if (m) {
                                do
            ...
            (function () {
                ...
                a.a.extend(a.L.prototype, { nodeHasBindings: function (b) {
                    ...
                    }, getBindingAccessors: function (b, d) { var c = this.getBindingsString(b, d), c = c ? this.parseBindingsString(c, d, b, { valueAccessors: !0 }) : null; return a.g.sb(c, b, d, !0); }, getBindingsString: function (b) {
                        switch (b.nodeType) {
            ...
            (function () {
                ...
                a.N = function (b, c, d, g) { var e = this, f = "function" == typeof b && !a.F(b), m, l = a.j(function () { var m = f ? b() : b, h = a.a.c(m); c ? (c.K && c.K(), a.a.extend(e, c), l && (e.K = l)) : (e.$parents = [], e.$root = h, e.ko = a); e.$rawData = m; e.$data = h; d && (e[d] = h); g && g(e, c, h); return e.$data; }, null, { Pa: function () { return m && !a.a.tb(m); }, q: !0 }); l.$() && (e.K = l, l.equalityComparer = null, m = [], l.Zb = function (b) { m.push(b); a.a.C.fa(b, function (b) { a.a.ya(m, b); m.length || (l.p(), e.K = l = p); }); }); };
                a.N.prototype.createChildContext = function (b, c, d) {
                    return new a.N(b, this, c, function (a, b) { a.$parentContext = b; a.$parent = b.$data; a.$parents = (b.$parents || []).slice(0); a.$parents.unshift(a.$parent); d && d(a); });
                };
                a.N.prototype.extend = function (b) { return new a.N(this.K || this.$data, this, null, function (c, d) { c.$rawData = d.$rawData; a.a.extend(c, "function" == typeof b ? b() : b); }); };
                ...
                a.va = function (b, c, d) { 1 === b.nodeType && a.e.Kb(b); return g(b, c, m(d), !0); };
                a.cc = function (b, c, d) { d = m(d); return a.va(b, e(c, d, b), d); };
            ...
            (function (b) {
                function d(d, e) { var g = f.hasOwnProperty(d) ? f[d] : b, m; g ? g.U(e) : (g = f[d] = new a.Q, g.U(e), c(d, function (a, b) { var c = !(!b || !b.synchronous); k[d] = { definition: a, tc: c }; delete f[d]; m || c ? g.notifySubscribers(a) : setTimeout(function () { g.notifySubscribers(a); }, 0); }), m = !0); }
                function c(a, b) {
                    e("getConfig", [a], function (c) { c ? e("loadComponent", [a, c], function (a) { b(a, c); }) : b(null, null); });
                }
                function e(c, d, g, f) {
            ...
            (function () {
                function b(b, c, d, e) {
                    ...
                    d = d.viewModel;
                    t ? f(c, t, function (c) { a.g.ob("loadTemplate", [b, c], function (a) { h.template = a; k(); }); }) : k();
                    d ? f(c, d, function (c) { a.g.ob("loadViewModel", [b, c], function (a) { h[l] = a; k(); }); }) :
                        k();
                }
                function d(a, b, c) {
                    if ("function" === typeof b)
                ...
                function c(b) {
                    switch (a.a.v(b)) {
                        case "script": return a.a.ca(b.text);
                ...
                a.g.Ec = function (b) { delete h[b]; a.g.zb(b); };
                a.g.Ab = { getConfig: function (a, b) { b(h.hasOwnProperty(a) ? h[a] : null); }, loadComponent: function (a, c, d) { var e = k(a); f(e, c, function (c) { b(a, e, c, d); }); }, loadTemplate: function (b, d, f) {
                        b = k(b);
                        if ("string" === typeof d)
                            f(a.a.ca(d));
            ...
            (function () {
                    ...
                    if (f) {
                        var f = d.parseBindingsString(f, e, b, { valueAccessors: !0, bindingParams: !0 }), f = a.a.pa(f, function (d) { return a.w(d, null, { q: b }); }), k = a.a.pa(f, function (d) {
                            ...
                            return d.$() ? a.w({ read: function () { return a.a.c(d()); },
                                write: a.Da(e) && function (a) { d()(a); }, q: b }) : e;
                        });
                ...
                a.g.getComponentNameForNode = function (b) { b = a.a.v(b); return a.g.Xa(b) && b; };
            ...
            (function (b) {
                ...
                function c(a, b, c, d) { var e = a.createViewModel; return e ? e.call(a, d, { element: b, templateNodes: c }) : d; }
                var e = 0;
                        ...
                        a.w(function () {
                            ...
                            a.g.get(h, function (e) {
                                if (q === p) {
                                    ...
                                    d(h, e, f);
                                    var l = c(e, f, n, t);
                                    e = g.createChildContext(l, b, function (a) { a.$component = l; a.$componentTemplateNodes = n; });
                                    x = l;
                                    a.Ja(e, f);
                                }
                            });
            ...
            a.d.attr = { update: function (b, d) { var c = a.a.c(d()) || {}; a.a.A(c, function (c, d) { d = a.a.c(d); var k = !1 === d || null === d || d === p; k && b.removeAttribute(c); 8 >= a.a.M && c in P ? (c = P[c], k ? b.removeAttribute(c) : b[c] = d) : k || b.setAttribute(c, d.toString()); "name" === c && a.a.Rb(b, k ? "" : d.toString()); }); } };
            (function () {
                a.d.checked = { after: ["value", "attr"], init: function (b, d, c) {
                        ...
                        function f() { var c = a.a.c(d()); b.checked = g ? 0 <= a.a.m(c, k()) : h ? c : k() === c; }
            ...
            a.d.css = { update: function (b, d) { var c = a.a.c(d()); null !== c && "object" == typeof c ? a.a.A(c, function (c, d) { d = a.a.c(d); a.a.Ia(b, c, d); }) : (c = String(c || ""), a.a.Ia(b, b.__ko__cssValue, !1), b.__ko__cssValue = c, a.a.Ia(b, c, !0)); } };
            ...
            a.d.options = { init: function (b) {
                    ...
                    g = k;
                    c.has("optionsAfterRender") && "function" == typeof c.get("optionsAfterRender") && (g = function (b, d) { k(0, d); a.k.u(c.get("optionsAfterRender"), null, [d[0], b !== L ? b : p]); });
            ...
            a.d.selectedOptions = { after: ["options", "foreach"], init: function (b, d, c) {
                    ...
                    var c = a.a.c(d());
                    c && "number" == typeof c.length && a.a.o(b.getElementsByTagName("option"), function (b) { var d = 0 <= a.a.m(c, a.i.s(b)); a.a.Sb(b, d); });
                } };
            ...
            (function () {
                ...
                if (10 > a.a.M)
                    var k = a.a.f.I(), h = a.a.f.I(), l = function (b) { var c = this.activeElement; (c = c && a.a.f.get(c, h)) && c(b); }, g = function (b, c) { var d = b.ownerDocument; a.a.f.get(d, k) || (a.a.f.set(d, k, !0), a.a.n(d, "selectionchange", l)); a.a.f.set(b, h, c); };
                a.d.textInput = { init: function (b, c, l) {
                        ...
                        function t() { clearTimeout(A); w = A = p; var d = b.value; u !== d && (u = d, a.h.ra(c(), l, "textInput", d)); }
                        var u = b.value, A, w;
            ...
            a.d.value = { after: ["options", "foreach"], init: function (b, d, c) {
                    if ("input" != b.tagName.toLowerCase() || "checkbox" != b.type && "radio" != b.type) {
                        ...
                        var l = function () { h = null; k = !1; var e = d(), g = a.i.s(b); a.h.ra(e, c, "value", g); };
                        !a.a.M || "input" !=
                        ...
                        a.a.o(e, function (c) { var d = l; a.a.Dc(c, "after") && (d = function () { h = a.i.s(b); setTimeout(l, 0); }, c = c.substring(5)); a.a.n(b, c, d); });
                        var g = function () {
                            ...
                            if (null !== h && e === h)
                                ...
                                if ("select" === a.a.v(b)) {
                                    var l = c.get("valueAllowUnset"), f = function () { a.i.Y(b, e, l); };
                                    f();
            ...
            a.h.V.value = !0;
            a.d.visible = { update: function (b, d) { var c = a.a.c(d()), e = "none" != b.style.display; c && !e ? b.style.display = "" : !c && e && (b.style.display = "none"); } };
            (function (b) { a.d[b] = { init: function (d, c, e, f, k) { return a.d.event.init.call(this, d, function () { var a = {}; a[b] = c(); return a; }, e, f, k); } }; })("click");
            a.J = function () { };
            ...
            a.J.prototype.rewriteTemplate = function (a, d, c) { a = this.makeTemplateSource(a, c); d = d(a.text()); a.text(d); a.data("isRewritten", !0); };
            ...
            (function () {
                ...
                function d(c, d) {
                    if (c.length) {
                        ...
                        if (r) {
                            b(e, f, function (a, b) { var c = a.previousSibling, d = r.call(k, a); d && (a === e && (e = d[0] || b), a === f && (f = d[d.length - 1] || c)); });
                            c.length = 0;
                            if (!e)
                                return;
                ...
                a.eb = function (b, d, h, x, q) {
                    ...
                    if (x) {
                        var n = c(x);
                        return a.j(function () { var k = d && d instanceof a.N ? d : new a.N(a.a.c(d)), p = f(b, k.$data, k), k = e(x, q, p, k, h); "replaceNode" == q && (x = k, n = c(x)); }, null, { Pa: function () { return !n || !a.a.Qa(n); }, q: n && "replaceNode" == q ? n.parentNode : n });
                    }
                ...
                a.Cc = function (b, c, h, k, q) {
                    ...
                    function r(a, c) { v = q.createChildContext(a, h.as, function (a) { a.$index = c; }); var d = f(b, a, v); return e(null, "ignoreTargetNode", d, v, h); }
                    var v;
                    return a.j(function () { var b = a.a.c(c) || []; "undefined" == typeof b.length && (b = [b]); b = a.a.xa(b, function (b) { return h.includeDestroyed || b === p || null === b || !a.a.c(b._destroy); }); a.k.u(a.a.fb, null, [k, b, r, h, n]); }, null, { q: k });
                };
                var h = a.a.f.I();
                ...
                a.h.ka.template = function (b) { b = a.h.bb(b); return 1 == b.length && b[0].unknown || a.h.vc(b, "name") ? null : "This template engine does not support anonymous templates nested within its templates"; };
                a.e.R.template = !0;
            })();
            ...
            (function () {
                function b(b, d, f, k, h) { var l = [], g = a.j(function () { var g = d(f, h, a.a.na(l, b)) || []; 0 < l.length && (a.a.Qb(l, g), k && a.k.u(k, null, [f, g, h])); l.length = 0; a.a.ia(l, g); }, null, { q: b, Pa: function () { return !a.a.tb(l); } }); return { aa: l, j: g.$() ? g : p }; }
                var d = a.a.f.I();
                a.a.fb = function (c, e, f, k, h) {
                    function l(b, d) { s = u[d]; t !== d && (z[b] = s); s.Ua(t++); a.a.na(s.aa, c); r.push(s); y.push(s); }
                    function g(b, c) {
                        if (b)
                            for (var d = 0, e = c.length; d < e; d++)
